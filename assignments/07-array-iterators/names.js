...
var a=names.filter(function(words)
{
    return words[0]=="z";
...
var b=names.filter(function(letters)
...
var c=names.filter(function(words)
{
...
var d=names.every(function(letters)
{
        return ((letters=="a")||(letters=="e")||(letters=="i")||(letters=="o")||(letters=="u")||(letters=="A")||(letters=="E")||(letters=="I")||(letters=="O")||(letters=="U"))
   
});
console.log(d)
//5. Are there any names that have only two letters?
var e=names.some(function(words){
...
var f=names.every(function(words){
...
var g=names.reduce(function(first,current){
    if(first>current)
        first=current;
    return first;
});
...
var c=0;
var h=names.forEach(function(words)
{
    
    words=words.split("")
    var y=words.forEach(function(letters){
        if(letters=="z")
        c=c+1
    });
...
var p=names.forEach(function(words)
    {
        var c=0;
        vowels=[aeiouAEIOU];
        words=words.split("")
        var s=words.forEach(function(letters){
